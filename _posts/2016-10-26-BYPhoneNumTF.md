...
@interface ZYPhoneNumTF : UITextField
...
#import "ZYPhoneNumTF.h"


@interface ZYPhoneNumTF ()<UITextFieldDelegate>

@end

@implementation ZYPhoneNumTF
...
在storyboard中的`TextField`控件的Calss类型选择该类`ZYPhoneNumTF`即可。

代码及Demo下载地址：[ZYPhoneNumTF](https://github.com/qiubaiying/ZYPhoneNumTF)
