...
创建一个字典并输出:
    ...
    NSDictionary *dic = @{@"name"  : @"ZY",
                           ...
                           @"set"     : set,
                           @"Unicode" : @"😀😁🤣😂😄",
                           @"contact" : @[@"ZY Blog:http://qiubaiying.top",
...
输出结果：
	...
	2017-03-01 10:36:45.709 ZYFoundationLog_Demo[1657:53604] {
	    "My bolg" = "http://qiubaiying.top";
	    Unicode = "\Ud83d\Ude00\Ud83d\Ude01\Ud83e\Udd23\Ud83d\Ude02\Ud83d\Ude04";
	    contact =     (
	        "ZY Blog:http://qiubaiying.top",
	        "GitHub:https://github.com/qiubaiying",
...
将`ZYFoundationLog.m`拖入项目，再次运行

	2017-03-01 10:35:52.545 ZYFoundationLog_Demo[1635:52772] 	{
		set = 	{(
			"str -> data格式的字符串",
			"set0",
				{
...
代码及Demo地址：[GitHub](https://github.com/qiubaiying/ZYFoundationLog)

## 使用方法

直接将 `ZYFoundationLog.m` 文件拖入项目中就能使用
